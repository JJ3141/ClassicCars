...
{
    /// <inheritdoc />
    public partial class FixUserTypeIdAndAddIdentity : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "miroslava@gmail.com", "Miroslava", "Tsaneva", "12345678", "user" },
                    { 2, "georgi@gmail.com", "Georgi", "Milanov", "password", "user1" },
                    { 3, "petkov@gmail.com", "Mitko", "Petkov", "password", "user2" }
                });
